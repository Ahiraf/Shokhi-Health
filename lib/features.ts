...
export const FEATURES: Feature[] = [
  ...
  },
  {
    href: "/learn",
    icon: "book",
    title_bn: "জানা ও যত্ন",
    title_en: "Learn & care",
    desc_bn: "রোগ, উপসর্গ, পুষ্টি, নিরাপত্তা ও বিশ্বস্ত স্বাস্থ্য গাইড — এক জায়গায়।",
    desc_en: "Conditions, symptoms, nutrition, safety, and trusted health guides in one place.",
    accent: "sage",
  },
  {
    href: "/myths",
